/**
 * ═══════════════════════════════════════════════════════════════
 * <nb-icon> — SVG Icon Component
 * Renders Lucide-style SVG icons inline.
 * Usage: <nb-icon name="search" size="20"></nb-icon>
 * ═══════════════════════════════════════════════════════════════
 */
import { NbComponent, defineComponent } from '@core/component.js';

/**
 * SVG icon paths — subset of Lucide icons for core UI.
 * Each entry is a valid SVG inner content for a 24x24 viewBox.
 */
const ICONS = {
  ...
  'file-bar-chart': '<path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z"/><path d="M14 2v4a2 2 0 0 0 2 2h4"/><path d="M12 18v-6"/><path d="M8 18v-1"/><path d="M16 18v-3"/>',
...
class NbIcon extends NbComponent {
...
defineComponent('nb-icon', NbIcon);
